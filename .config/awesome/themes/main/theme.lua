...
theme.taglist_font							= font_terminus
theme.fg_normal								= color_white
theme.fg_focus									= color_yellow
theme.fg_urgent								= color_red
theme.bg_normal								= color_black
theme.bg_focus									= color_black
theme.bg_urgent								= color_black
theme.border_width							= "0"
theme.border_normal							= color_black
theme.border_focus							= color_yellow
theme.border_marked							= color_yellow
theme.titlebar_bg_focus						= color_yellow
theme.titlebar_bg_normal					= color_white
theme.taglist_fg_focus						= color_yellow
theme.tasklist_bg_focus						= color_black
theme.tasklist_fg_focus						= color_yellow
...
theme.mouse_finder_color					= color_yellow
